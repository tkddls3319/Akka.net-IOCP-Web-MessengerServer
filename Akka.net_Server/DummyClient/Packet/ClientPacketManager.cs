...
class PacketManager
{
	...
	{		
		_onRecv.Add((ushort)PacketID.SEnterServer, MakePacket<S_EnterServer>);
		_handler.Add((ushort)PacketID.SEnterServer, PacketHandler.S_EnterServerHandler);		
		_onRecv.Add((ushort)PacketID.SLeaveServer, MakePacket<S_LeaveServer>);
		_handler.Add((ushort)PacketID.SLeaveServer, PacketHandler.S_LeaveServerHandler);		
