...
또한, 다중 클라이언트 BoradCasting을 사용하면서 서버의 부하를 줄이는 방법을 고민하였고, IOCP방식이 아닌 Redis의 pub/sub과 WebRTC를 활용한 방식을 생각해봤다.
...
Akka.NET의 Actor모델과 IOCP(Input/Output Completion Port)를 결합하여 **고성능 메신저 채팅 서버**를 개발 하였습니다. 설계 및 구현 방안을 고민하며, 확장성과 유지보수성을 강화하는 데 중점을 두었습니다.
